<?php
  ...
  class Constants
  {
      ...
      public static $passwordAlphanumeric = "Your password can only contain numbers and letters";
      ...
      public static $lastNameCharacters = "Your lastname must be between 2 and 5 characters";
